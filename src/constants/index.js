 ...
 fiverr,
  ...
  const projects = [
    ...
    },
    {
      name: "Code Huntify",
      description:
        "Code Huntify is the nextjs application where you find numerous blogs related to coding , programming , technology and artifical intelligence. Code Huntify offers comprehensive guide on modern programming languages and frameworks.",
      tags: [
        {
          name: "Next.js",
          color: "blue-text-gradient",
      ...
      image: codeh7,
      source_code_link: "https://github.com/Anasch113/codehuntify",
    },
    {
      name: "Netflix Clone",
      description:
        "This is a Movie application which is a full-stack project. A user can first create an account and then log in to use the application. A user can watch and download their favourite movies, TV shows and more.",
      tags: [
        {
          name: "React",
          color: "blue-text-gradient",
      ...
      image: netflix,
      source_code_link: "https://github.com/Anasch113/Netflix-clone",
    },
    {
      name: "EduTech",
      description:
    ...
    },
    {
      name: "UGC Hub",
      description:
        "I converted this figma design into code and make it a functional website using MERN technology. ",
      tags: [
        {
          name: "javascript",
          color: "blue-text-gradient",
